...
def mtz_ex():
    ...
    return matriz_adj # Retornando o resultado
...
def matriz_incidencia():
    ...
    num_arestas = matriz_adj.shape[1]
...
def matriz_similaridade():
    ...
    num_linhas = matriz_inc.shape[0]
    num_colunas = matriz_inc.shape[1]

    # Dar inicío a matriz de similaridade
    matriz_similaridade = np.zeros((num_linhas, num_linhas), dtype=int)

    # Preencher a matriz de similaridade
    for i in range(num_linhas):
        for j in range(num_linhas):
            # Contar o número de colunas, onde ambas as linhas i e j têm o valor 1
...
def matriz_coocorrencia():
    ...
    # Início a matriz de coocorrência
